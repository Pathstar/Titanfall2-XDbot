...
> | `@xd 查询武器 (模糊武器名)` | *todo* 查询拿着该武器的玩家，武器可写多个，例如：<br />`@xd 查询武器 A盾 喷火 手雷` |
> | `@xd 井字棋`                | 两人输入后开启井字棋，可用 `@xd 3 1` 落子到第三列第一行      |
> | `@xd 打开/关闭连杀播报`     | 控制连杀播报开关                                             |
> | `@xd 进入/退出操控模式`     | 远程操控我自己，格式见操控模式指令                           |
> | `@xd 服务器 模式/名称 值`   | 模糊查询服务器人数，格式见查询服务器指令                     |
>
> #### AI设置指令
>
> | 指令                           | 功能           |
...
> | 指令                        | 返回                                                         |
> | --------------------------- | ------------------------------------------------------------ |
> | `@xd 服务器 模式 铁对铁`    | 2人，[NSCN] 北极星CN官方原版铁对铁#1...等                    |
> | `@xd server mode pvp`       | 2人，[NSCN] 北极星CN官方原版铁对铁#1...等                    |
> | `@xd 服务器 名称 小图`      | 4人，[CN]坏逼们的服务器#`小图`铁对铁                         |
> | `@xd 服务器 名称 小图 nscn` | 4人，[CN]坏逼们的服务器#`小图`铁对铁<br />2人，[`NSCN`] 北极星CN官方原版铁对铁#1...等 |
> | `@xd server name nscn`      | 2人，[`NSCN`] 北极星CN官方原版铁对铁#1...等                  |
>
> 更多示例：
>
> | 命令                       | 英文命令                  |
